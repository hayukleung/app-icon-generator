...
# 配置尺寸数组
imageSize=(20 29 40 57 58 60 76 80 87 114 120 128 136 152 167 180 192 256 512)
...
iPhoneIconWithSize() {
iPhoneSize=`expr $1 \* 1`
sips -Z $iPhoneSize $imagePath --out ${exportPath}/AppIcon.appiconset/icon_$1x$1@1x.png
iPhoneSize=`expr $1 \* 2`
